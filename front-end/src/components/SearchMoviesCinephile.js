...
function SearchMovies() {
  ...
  const [keyword, setKeyword] = useState("r");
  ...
  useEffect(() => {
    ...
    //const endpoin = `https://www.omdbapi.com/?s=${keyword}&apikey=${apiKey}`;
    const endpoint = `http://localhost:3030/product/search?product=${keyword}`
                      ...
                      <div className="card-body">
                        <div className="text-center">
                          <img
                            ...
                            src={
                              movie.Poster !== "N/A" ? movie.Poster : noPoster
                            }
                            alt={movie.Title}
                            style={{
                              width: "90%",
